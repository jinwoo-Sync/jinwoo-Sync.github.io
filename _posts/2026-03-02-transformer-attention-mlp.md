...
## 2. Attention: 토큰 간 정보 교환

### 2.1 Attention이 해결하는 문제
...
Attention 없이 MLP만으로는 이걸 처리할 수 없다. MLP는 각 토큰을 **독립적으로** 처리하기 때문이다. 토큰 간 정보 교환이 일어나지 않는다.
